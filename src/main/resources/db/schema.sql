CREATE DATABASE IF NOT EXISTS xiaolanshu DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE xiaolanshu;
...
CREATE TABLE `t_data_align_following_count_temp_20241102_0` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
CREATE TABLE `t_data_align_fans_count_temp_20241102_0` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` bigint unsigned NOT NULL COMMENT '用户ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_user_id` (`user_id`)
...
CREATE TABLE `t_data_align_note_collect_count_temp_20241102_0` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
CREATE TABLE `t_data_align_user_collect_count_temp_20241102_0` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` bigint unsigned NOT NULL COMMENT '用户ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_user_id` (`user_id`)
...
CREATE TABLE `t_data_align_user_like_count_temp_20241102_0` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` bigint unsigned NOT NULL COMMENT '用户ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_user_id` (`user_id`)
...
CREATE TABLE `t_data_align_note_like_count_temp_20241102_0` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `note_id` bigint unsigned NOT NULL COMMENT '笔记ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_note_id` (`note_id`)
...
CREATE TABLE `t_data_align_note_publish_count_temp_20241112_0` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` bigint unsigned NOT NULL COMMENT '用户ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_user_id` (`user_id`)
...
CREATE TABLE `t_note` (
  ...
  `content_uuid` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '笔记内容UUID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `t_user` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `xiaolanshu_id` varchar(15) NOT NULL COMMENT '小蓝书号(唯一凭证)',
  ...
  `is_deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '逻辑删除(0：未删除 1：已删除)',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_xiaolanshu_id` (`xiaolanshu_id`),
