package com.quanxiaoha.xiaolanshu.distributed.id.generator.biz.core.snowflake;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.common.collect.Maps;
import com.quanxiaoha.xiaolanshu.distributed.id.generator.biz.core.common.PropertyFactory;
import com.quanxiaoha.xiaolanshu.distributed.id.generator.biz.core.snowflake.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    ...
    private static final String PREFIX_ZK_PATH = "/snowflake/" + PropertyFactory.getProperties().getProperty("leaf.name", "xiaolanshu");
    private static final String PROP_PATH = PropertyFactory.getProperties().getProperty("leaf.local-cache-dir", "D:/Environment/java-tmp") + File.separator + PropertyFactory.getProperties().getProperty("leaf.name", "xiaolanshu") + "/leafconf/{port}/workerID.properties";
    ...
    private void updateLocalWorkerID(int workerID) {
        ...
        if (exists) {
            try {
                Files.writeString(leafConfFile.toPath(), "workerID=" + workerID);
