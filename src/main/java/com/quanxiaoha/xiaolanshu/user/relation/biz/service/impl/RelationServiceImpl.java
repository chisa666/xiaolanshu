package com.quanxiaoha.xiaolanshu.user.relation.biz.service.impl;
...
import com.quanxiaoha.xiaolanshu.user.relation.biz.constant.MQConstants;
import com.quanxiaoha.xiaolanshu.user.relation.biz.constant.RedisKeyConstants;
import com.quanxiaoha.xiaolanshu.user.relation.biz.domain.dataobject.FansDO;
import com.quanxiaoha.xiaolanshu.user.relation.biz.domain.dataobject.FollowingDO;
import com.quanxiaoha.xiaolanshu.user.relation.biz.domain.mapper.FansDOMapper;
import com.quanxiaoha.xiaolanshu.user.relation.biz.domain.mapper.FollowingDOMapper;
import com.quanxiaoha.xiaolanshu.user.relation.biz.enums.LuaResultEnum;
import com.quanxiaoha.xiaolanshu.user.relation.biz.enums.ResponseCodeEnum;
...
public class RelationServiceImpl implements RelationService {
    ...
    public Response<?> follow(FollowUserReqVO followUserReqVO) {
        ...
        /*
         以上操作完成了Redis 数据，接下来发送 MQ完成数据库数据同步
         */
        // 发送 MQ
        //构建消息体MQ
