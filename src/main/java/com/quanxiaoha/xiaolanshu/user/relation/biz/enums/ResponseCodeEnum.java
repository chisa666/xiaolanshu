package com.quanxiaoha.xiaolanshu.user.relation.biz.enums;
...
public enum ResponseCodeEnum implements BaseExceptionInterface {
    ...
    CANT_FOLLOW_YOUR_SELF("RELATION-20001", "不能关注自己"),
    FOLLOW_USER_NOT_EXISTED("RELATION-20002", "关注的用户不存在"),
    FOLLOWING_COUNT_LIMIT("RELATION-20003", "关注数量已达上限"),
    ALREADY_FOLLOWED("RELATION-20004", "已经关注该用户"),
