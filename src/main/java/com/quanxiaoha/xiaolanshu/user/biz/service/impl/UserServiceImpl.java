package com.quanxiaoha.xiaolanshu.user.biz.service.impl;
...
import com.quanxiaoha.xiaolanshu.user.biz.constant.MQConstants;
import com.quanxiaoha.xiaolanshu.user.biz.constant.RedisKeyConstants;
import com.quanxiaoha.xiaolanshu.user.biz.constant.RoleConstants;
import com.quanxiaoha.xiaolanshu.user.biz.domain.dataobject.RoleDO;
import com.quanxiaoha.xiaolanshu.user.biz.domain.dataobject.UserDO;
import com.quanxiaoha.xiaolanshu.user.biz.domain.dataobject.UserRoleDO;
import com.quanxiaoha.xiaolanshu.user.biz.domain.mapper.RoleDOMapper;
import com.quanxiaoha.xiaolanshu.user.biz.domain.mapper.UserDOMapper;
import com.quanxiaoha.xiaolanshu.user.biz.domain.mapper.UserRoleDOMapper;
import com.quanxiaoha.xiaolanshu.user.biz.enums.ResponseCodeEnum;
import com.quanxiaoha.xiaolanshu.user.biz.enums.SexEnum;
import com.quanxiaoha.xiaolanshu.user.biz.model.vo.FindUserProfileReqVO;
import com.quanxiaoha.xiaolanshu.user.biz.model.vo.FindUserProfileRspVO;
import com.quanxiaoha.xiaolanshu.user.biz.model.vo.UpdateUserInfoReqVO;
import com.quanxiaoha.xiaolanshu.user.biz.rpc.CountRpcService;
import com.quanxiaoha.xiaolanshu.user.biz.rpc.DistributedIdGeneratorRpcService;
import com.quanxiaoha.xiaolanshu.user.biz.rpc.OssRpcService;
import com.quanxiaoha.xiaolanshu.user.biz.service.UserService;
import com.quanxiaoha.xiaolanshu.user.biz.util.ParamUtils;
import com.quanxiaoha.xiaolanshu.user.dto.req.*;
...
import com.quanxiaoha.xiaolanshu.user.biz.config.ThreadPoolConfig;
    ...
    public Response<List<FindUserByIdRspDTO>> findByIds(FindUsersByIdsReqDTO findUsersByIdsReqDTO) {
        ...
        if (CollUtil.isNotEmpty(redisValues)){
            findUserByIdRspDTOS  = redisValues.stream()
                    .map(value -> JsonUtils.parseObject(value.toString(), FindUserByIdRspDTO.class))
