package com.quanxiaoha.xiaolanshu.comment.biz.service.impl;
...
import com.quanxiaoha.xiaolanshu.comment.biz.constant.RedisKeyConstants;
import com.quanxiaoha.xiaolanshu.comment.biz.domain.dataobject.CommentDO;
import com.quanxiaoha.xiaolanshu.comment.biz.domain.dataobject.CommentLikeDO;
import com.quanxiaoha.xiaolanshu.comment.biz.domain.mapper.CommentDOMapper;
import com.quanxiaoha.xiaolanshu.comment.biz.domain.mapper.CommentLikeDOMapper;
import com.quanxiaoha.xiaolanshu.comment.biz.domain.mapper.NoteCountDOMapper;
import com.quanxiaoha.xiaolanshu.comment.biz.enums.*;
import com.quanxiaoha.xiaolanshu.comment.biz.model.dto.LikeUnlikeCommentMqDTO;
import com.quanxiaoha.xiaolanshu.comment.biz.model.dto.PublishCommentMqDTO;
import com.quanxiaoha.xiaolanshu.comment.biz.model.vo.*;
import com.quanxiaoha.xiaolanshu.comment.biz.retry.SendMqRetryHelper;
import com.quanxiaoha.xiaolanshu.comment.biz.rpc.DistributedIdGeneratorRpcService;
import com.quanxiaoha.xiaolanshu.comment.biz.rpc.KeyValueRpcService;
import com.quanxiaoha.xiaolanshu.comment.biz.rpc.UserRpcService;
...
public class CommentServiceImpl implements CommentService {
    ...
    public PageResponse<FindChildCommentItemRspVO> findChildCommentPageList(FindChildCommentPageListReqVO findChildCommentPageListReqVO) {
        ...
        //先从缓存中查
        //构建RedisKey
        String countCommentKey = RedisKeyConstants.buildCommentListKey(parentCommentId);
        //子评论数
    ...
    private void getChildCommentDataAndSync2Redis(List<CommentDO> childCommentDOS, List<FindChildCommentItemRspVO> childCommentRspVOS) {
        ...
        for (CommentDO childCommentDO : childCommentDOS) {
            ...
            // 若当前评论的 replyCommentId 不等于 parentId，则前端需要展示回复的哪个用户，如  “回复 chisa：”
